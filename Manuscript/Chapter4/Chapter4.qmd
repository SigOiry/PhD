...
The elevation map showed that the main mats of G. vermiculophylla were located between 1 and 2 m above mean sea level (@fig-Belon C). The presence of red macroalgae was strongly influenced by the elevation, with lower intertidal zones closer to the tidal channel consistently exhibiting reduced cover. 
Most of the intertidal flats exihbited angle below 10° (Violet, (@fig-Belon D). Angled surfaces (10° < angle < 40°) often found adjacent to tidal channels, exhibited almost no vegetation cover.
...
#| echo: false
#| warning: false
#| fig-cap: DISCOV Prediction (A), RGB composition (B) and Bathymetry (C) of the Belon estuary site in Brittany, France. The total extent of this flight was 21 ha with a resolution of 8 mm per pixel. Bathymetry is represented as the height above mean sea level. 
#| label: fig-Gam_Slope
#| out-width: "95%"
...
#| echo: false
#| warning: false
#| fig-cap: "Annexe 4.4 - DISCOV Prediction (A), RGB composition (B) and picture of the field campaign of the Saja estuary, Nothern Spain. The total extent of this flight was 20.4 ha with a resolution of 8 mm per pixel."
#| label: fig-Saja_g
#| out-width: "95%"
