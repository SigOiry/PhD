---
title: "Chapter 2: Multi- and hyperspectral classification of soft-bottom intertidal vegetation using a spectral library for coastal biodiversity remote sensing"
---
...
flxtbl <- Table %>% 
  ...
  flextable::align(align = "justify", part = "body") %>%  # Justify text in the body cells
  flextable::align(align = "justify", part = "header") %>%  # Justify text in the header cells
  flextable::autofit() %>% 
  flextable::set_table_properties(layout="autofit") ## last two lines make table fit word doc width 

# Display the flextable
# save_as_image(flxtbl, path = "Manuscript/Chapter1/Figs/SPECIESTABLE.png")
...
# save_as_image(flxtable, path = "Manuscript/Chapter1/Figs/pigmentTable.png")
