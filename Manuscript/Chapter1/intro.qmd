...
#| echo: false
#| warning: false
#| fig-cap: "One of Neubronner’s pigeons (Top), around 1910 equipped with a camera. Bottom shows a picture took during a pigeon's flight."
#| label: fig-pigeons
#| out-width: "90%"
...
Another optional step, depending on the dataset, is the radiometric calibration of the data. However, this step becomes mandatory for multispectral and hyperspectral datasets, as it ensures the accuracy and usability of radiometric informations by compensating for sensor-specific biases and environmental conditions during data acquisition.
