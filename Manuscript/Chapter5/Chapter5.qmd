...
#| echo: false
#| warning: false
#| fig-cap: "Sentinel-2 color composition of the seagrass meadow of Quiberon, South Brittany, France, Before (A ; 1st of September 2021), During (B ; 6th of September 2021) and After (C ; 8th of October 2021) the HW and SHSI applied to the same Sentinel-2 images Before (D), During (E) and After (F) the HW."
...
flextable_table %>% 
  ...
  flextable::width(j = c("Index"), width = 1) # Set narrower columns
